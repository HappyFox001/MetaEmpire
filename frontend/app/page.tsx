    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-900 overflow-hidden">
      ...
      <main className="flex min-h-[calc(100vh-64px)]">
        ...
        <aside className="w-80 border-l border-gray-800 p-4 flex flex-col bg-gray-950/90 backdrop-blur-sm">
          ...
          <div className="flex gap-2 border-t pt-4 border-gray-800">
            <Input placeholder="发表你的观点..." className="border-blue-900 bg-gray-950 text-gray-100 placeholder-gray-500 focus:border-blue-400 focus:ring-blue-500" />
            <Button className="bg-blue-700 hover:bg-blue-600 text-white">发送</Button>
          </div>
        </aside>
      </main>
